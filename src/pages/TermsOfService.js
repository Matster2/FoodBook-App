...
export default () => {
  ...
  return (
    <Container component="main" maxWidth="xs">
      ...
      <p>Welcome to FoodBook!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use of FoodBook&apos;s Website, located at
        https://foodbook.dev.
      </p>

      <p>
        By accessing this website we assume you accept these terms and conditions. Do not continue to use FoodBook if
      ...
      <p>
        ...
        af. Any use of the above terminology or other words in the singular, plural, capitalization and/or he/she or
      ...
      <p>
        We employ the use of cookies. By accessing FoodBook, you agreed to use cookies in agreement with the
        FoodBook&apos;s Privacy Policy.{' '}
      </p>
      ...
      <p>
        Unless otherwise stated, FoodBook and/or its licensors own the intellectual property rights for all material on
        FoodBook. All intellectual property rights are reserved. You may access this from FoodBook for your own personal
        use subjected to restrictions set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from FoodBook</li>
        <li>Sell, rent or sub-license material from FoodBook</li>
        <li>Reproduce, duplicate or copy material from FoodBook</li>
        <li>Redistribute content from FoodBook</li>
      </ul>
      ...
      <p>
        ...
        areas of the website. FoodBook does not filter, edit, publish or review Comments prior to their presence on the
        website. Comments do not reflect the views and opinions of FoodBook,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
        applicable laws, FoodBook shall not be liable for the Comments or for any liability, damages or expenses caused
        and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
      </p>

      <p>
        FoodBook reserves the right to monitor all Comments and to remove any Comments which can be considered
      ...
      <p>
        You hereby grant FoodBook a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce
      ...
      <p>
        ...
        records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of FoodBook;
      ...
      <p>
        ...
        you must inform us by sending an e-mail to FoodBook. Please include your name, your organization name, contact
      ...
      <p>
        No use of FoodBook&apos;s logo or other artwork will be allowed for linking absent a trademark license
        agreement.
      </p>
