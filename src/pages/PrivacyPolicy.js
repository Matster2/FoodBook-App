  ...
  return (
    <Container>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to FoodBook, the software program provided by the Company.
          </p>
        </li>
        <li>
          <p>
            <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
            &quot;Our&quot; in this Agreement) refers to FoodBook.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to FoodBook, accessible from{' '}
            <a href="https://foodbook.dev" rel="external nofollow noopener noreferrer" target="_blank">
              foodbook.dev
            </a>
          </p>
        </li>
      ...
      <ul>
        <li>
          ...
          <a href="https://foodbook.dev/contact-us" rel="external nofollow noopener noreferrer" target="_blank">
            foodbook.dev/contact-us
          </a>
        </li>
      </ul>
    </Container>
